...
class WishList extends Database {
  ...
  public function addItem( $product_id ){
    ...
    $add_query = " INSERT INTO wishlist_item (wishlist_id,product_id,created) VALUES (?, ?, NOW() ) ";
  ...
  private function createWishList( $account_id ){
    ...
    $create_query = "INSERT INTO wishlist (account_id,created,active) VALUES ( UNHEX(?), NOW(), 1 )";
  ...
  public function getWishListTotal(){
    ...
    $get_query = "SELECT COUNT(product_id) AS total FROM wishlist_item WHERE wishlist_id = ?";
  ...
  public function getWishListItemsSnowboards(){
    ...
    (SELECT image_file_name FROM image WHERE image.image_id = @image_id ) AS image,
        ...
        FROM wishlist_item
        INNER JOIN product_snowboarding ON wishlist_item.product_id = product_snowboarding.product_id WHERE wishlist_item.wishlist_id = ?";
  ...
  public function removeItem($product_id){
    ...
    $delete_query = "DELETE FROM wishlist_item WHERE product_id = ? AND wishlist_id = ?";
